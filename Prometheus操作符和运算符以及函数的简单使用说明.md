...
![2](./images/截屏2023-07-29%2022.37.41.png)
**使用 >= 操作符返回的示例结果（不带bool修饰符）**

![3](./images/截屏2023-07-29%2022.45.45.png)
**使用 >= 返回的示例结果（带bool修饰符）**

![4](./images/截屏2023-07-29%2022.47.42.png)
...
![5](./images/截屏2023-07-29%2022.41.31.png)
**使用 < 操作符的结果示例（带bool修饰符）**

![5](./images/截屏2023-07-29%2022.42.12.png)
...
![12](./images/截屏2023-07-30%2000.13.34.png)
**在不使用ignoring或者on关键字时的演示结果：**

![13](./images/截屏2023-07-30%2000.21.37.png)
以上的结果可以发现对两个不匹配的向量进行算术运算时，结果为空。

**ignoring关键字使用的演示结果:**

![14](./images/截屏2023-07-30%2000.14.14.png)
**在不使用ignoring的前提下，上面两个向量是不匹配的，因为其中一个标签无法匹配。当使用了ignoring来忽略不匹配的标签以后，运算符两侧的向量匹配。**

**on关键字使用的演示结果:**

![15](./images/截屏2023-07-30%2000.24.11.png)
### 多对一和一对多向量匹配
...
![16](./images/截屏2023-07-30%2001.25.28.png)
等价于

![17](images/截屏2023-07-30%2001.26.51.png)
**一对一其实是特殊的一对多或者多对一，因此也能使用group_left和group_right**

![18](./images/截屏2023-07-30%2001.34.41.png)
和
![19](./images/截屏2023-07-30%2001.35.03.png)
**多对一示例：**

![20](./images/截屏2023-07-30%2001.37.12.png)
**一对多示例：**

![21](./images/截屏2023-07-30%2010.06.20.png)
...
![22](./images/截屏2023-07-30%2010.18.36.png)
...
![23](./images/截屏2023-07-30%2010.28.09.png)
和
![24](./images/截屏2023-07-30%2010.28.58.png)
### by子句使用示例

![25](./images/截屏2023-07-30%2010.25.17.png)
和
![26](./images/截屏2023-07-30%2010.25.40.png)
...
![27](./images/截屏2023-07-30%2014.37.06.png)
...
![28](./images/截屏2023-07-30%2014.45.15.png)
